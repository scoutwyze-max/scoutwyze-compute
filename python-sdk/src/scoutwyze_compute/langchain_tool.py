...
mid-conversation.
    ...
    pip install "scoutwyze-compute[langchain]"
...
integration for a LangChain agent that already expects a single
...
at all — see client.py's rank_via_x402 for what that actually does
(real on-chain USDC transfer, not a mock).
"""
